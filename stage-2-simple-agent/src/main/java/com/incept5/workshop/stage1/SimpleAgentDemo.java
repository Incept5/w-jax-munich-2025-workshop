 ...
 * 
 * Usage:
 *   java -jar stage-1-simple-agent.jar
 *   java -jar stage-1-simple-agent.jar "What's the weather in Tokyo?"
 *   java -jar stage-1-simple-agent.jar --verbose "Weather in Paris vs Berlin"
 */
public class SimpleAgentDemo {
    ...
    private static void printHelp() {
        System.out.println("""
                ...
                Usage:
                  java -jar stage-1-simple-agent.jar [OPTIONS] [TASK]
                ...
                Examples:
                  ...
                  java -jar stage-1-simple-agent.jar "What's the weather in Japan's capital?"
                
                  # Comparison task
                  java -jar stage-1-simple-agent.jar "Compare weather in Paris and Berlin"
                
                  # With verbose output
                  java -jar stage-1-simple-agent.jar --verbose "Tell me about Brazil"
